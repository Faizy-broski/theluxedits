...
/**
 * A single faceted-gem line drawing, echoing the "luxury edits" catalogue
 * subject without leaning on any literal brand mark. Pure stroke, no fill,
 * so it reads as an etching rather than an icon.
 */
